...
class SearchFlightTrackAsyncTask (requestListener: RequestsManager.RequestListener) :
    ...
    override fun doInBackground(vararg searchTrackModel: SearchFlightTrackDataModel?): String? {
    ...
    private fun getRequestParams(searchTrackModel: SearchFlightTrackDataModel?): Map<String, String>? {
